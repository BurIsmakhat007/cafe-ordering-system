            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="includes/reg.php">
                            ...
                            <button type="submit" class="btn btn-outline-success btn-sm " name="RegBtn">Register</button>
                        </form>

            <a type="button" class="btn btn-outline-secondary btn-sm mt-5 text-center ml-5" href="login.php"">Already have account? Click here to login</a>
